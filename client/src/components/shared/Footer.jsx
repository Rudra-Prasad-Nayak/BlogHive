      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              Discover, share, and connect with our vibrant community of writers
              and readers. BlogHive is your platform for inspiration and
              knowledge.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-dark-700">
          <p className="text-sm text-center text-gray-500 dark:text-gray-400">
            &copy; {currentYear} BlogHive. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
